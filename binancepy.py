...
class MarketData:
    def __init__(self, testnet: bool = False, symbol: str = 'btcusdt'):
    ...
    def aggregate_trades(self, fromId: int = None, startTime: int = None, endTime: int = None, limit: int = 500):
        """
        To change limit                     ->  limit = 1000
        (max 1000)
    ...
    def candles_data(self, interval: str = '1m', startTime: int = None, endTime: int = None, limit: int = 500):
        """
    ...
    def funding_rate(self, startTime: int = None, endTime: int = None, limit: int = 100):
        """
        To change limit                     ->  limit = 1000
        (max 1096)
